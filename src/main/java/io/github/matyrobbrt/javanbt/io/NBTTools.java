...
public class NBTTools {
     ...
     *                          amount of bytes specified by the
     *                          {@code sizeAccounter}
     */
    ...
    /**
     * Writes a compound to the output.
     * 
     * @param  nbtCompound the compound to write
     * @param  output      the output to write on
     * @throws IOException if an exception occurred writing the data
     */
