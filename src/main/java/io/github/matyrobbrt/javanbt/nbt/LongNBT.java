...
public class LongNBT extends NumberNBT {
	...
	public static final NBTType<LongNBT> TYPE = new NBTType<LongNBT>() {
		...
		@Override
		public String getPrettyName() { return "TAG_Long"; }
	...
	@Override
	public NBTType<LongNBT> getType() { return TYPE; }
	...
	@Override
	public int getAsInt() { return (int) (this.data & -1L); }

	@Override
	public short getAsShort() { return (short) ((int) (this.data & 65535L)); }

	@Override
	public byte getAsByte() { return (byte) ((int) (this.data & 255L)); }
